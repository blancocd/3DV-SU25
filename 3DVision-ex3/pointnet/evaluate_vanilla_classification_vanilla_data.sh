...
#SBATCH --mem=64gb
#SBATCH --output=evaluate_classification_vanilla.txt
#SBATCH --error=evaluate_classification_vanilla.txt
...
python main.py --task "cls" --vanilla --load_checkpoint vanilla_best_model