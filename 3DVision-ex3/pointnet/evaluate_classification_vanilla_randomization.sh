...
#SBATCH --mem=64gb
#SBATCH --output=evaluate_classification_vanilla_randomization.txt
#SBATCH --error=evaluate_classification_vanilla_randomization.txt
...
python main.py --task "cls" --randomization --vanilla --load_checkpoint vanilla_best_model